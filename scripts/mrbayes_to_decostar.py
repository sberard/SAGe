...
if len(parameters) < 3:
    print "usage: python mrbayes_to_decostar.py ale_dir decostar_dir name"
    exit()

ale_dir = parameters[0]
...
gene_trees_files = os.listdir(ale_dir+"/G/Gene_trees/")
